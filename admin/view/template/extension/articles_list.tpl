            ...
            <table class="table table-bordered table-striped table-hover">
			  ...
			  <tbody>
				<?php if ($all_articles) { ?>
				  ...
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $articles['articles_id']; ?>" /></td>
					<td class="text-left"><?php echo $articles['title']; ?></td>
					<td class="text-left"><?php echo $articles['short_description']; ?></td>
					<td class="text-left"><?php echo $articles['date_added']; ?></td>
					<td class="text-right">[ <a href="<?php echo $articles['edit']; ?>"><?php echo $text_edit; ?></a> ]</td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
